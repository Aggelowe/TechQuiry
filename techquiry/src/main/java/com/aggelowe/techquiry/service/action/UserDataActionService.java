...
/**
 * The {@link UserDataActionService} class is a dependency of {@link UserDataService} whose methods provide different functionality for
 * different users.
 *
 * @author Aggelowe
 * @since 0.0.1
...
public class UserDataActionService {
    ...
    /**
     * The object responsible for handling the data access for {@link UserData} objects.
     */
    private final UserDataDao userDataDao;

    /**
     * The object responsible for handling the data access for {@link UserLogin } objects.
     */
    private final UserLoginDao userLoginDao;

    /**
     * This constructor constructs a new {@link UserDataActionService} instance that is handling the personalized user data operations of
     * the application.
     * 
     * @param databaseManager
     *            The object managing the application database
     * @param current
     *            The user initializing the operations
     */
    @Autowired
    public UserDataActionService(final UserSessionHelper userSessionHelper, final UserDataDao userDataDao,
     ...
     *             If the current user does not have the given id
     * @throws EntityNotFoundException
     *             If the given id does not correspond to a user login id
     * @throws InvalidRequestException
     *             If the given first or last name are empty or if the given id is not available
     * @throws InternalErrorException
     *             If an internal error occurs while creating the user data
     * 
     */
     ...
     *             If the current user does not have the given id
     * @throws EntityNotFoundException
     *             If the requested user data do not exist
     * @throws InternalErrorException
     *             If an internal error occurred while deleting the user
     */
    ...
    /**
     * This method updates an existing user data with the data from the given {@link UserData} object.
     * 
     * @param data
     *            The user data
     * @throws ForbiddenOperationException
     ...
     *             If the given first or last name are empty or if the given id is not available
     * @throws InternalErrorException
     *             If an internal error occurred while updating the user data
     * 
     */
